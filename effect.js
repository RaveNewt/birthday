...
$("document").ready(function () {
    ...
    $(window).resize(function () {
        ...
        $("#b11").animate({ top: 440, left: vw - 200 }, 1000);
        $("#b22").animate({ top: 180, left: vw - 200 }, 500);
        $("#b33").animate({ top: 180, left: vw - 100 }, 500);
        $("#b44").animate({ top: 180, left: vw + 0 }, 500);
        $("#b55").animate({ top: 180, left: vw + 100 }, 500);
        $("#photo").animate({ top: 240, left: vw + 150 }, 1000);
        $("#b66").animate({ top: 500, left: vw + 120 }, 500);
    ...
    $("#balloons_flying").click(function () {
        ...
        $("#photo").addClass("balloons-rotate-behaviour-one");
    ...
    $("#wish_message").click(function () {
        ...
        $("#b6").attr("id", "b66");
        $("#b7").attr("id", "b77");
        $("#b11").animate({ top: 350, left: vw - 200 }, 1000);
        $("#b22").animate({ top: 180, left: vw - 200 }, 500);
        $("#b33").animate({ top: 180, left: vw - 100 }, 500);
        $("#b44").animate({ top: 180, left: vw + 0 }, 500);
        $("#b55").animate({ top: 180, left: vw + 100 }, 500);
